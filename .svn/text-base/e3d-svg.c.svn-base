  ...
  for (s = stl->slices; s; s = s->next)
    {
      ...
      void outpath (polygon_t * p, const char *style)
      {
	if (!p)
	  return;
	...
	fprintf (f, "\"/>\n");
      ...
      char temp[1000];
      outpath (s->outline, "fill:#ff8;stroke:none;fill-opacity:0.5");
      outpath (s->solid, "fill:#f88;stroke:none;fill-opacity:0.5");
      outpath (s->infill, "fill:#8ff;stroke:none;fill-opacity:0.5");
      outpath (s->flying, "fill:#f8f;stroke:none;fill-opacity:0.5");
